  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `post` (`id` INTEGER, `title` TEXT, `body` TEXT, `userId` INTEGER, `isShimmer` INTEGER NOT NULL, `postId` TEXT NOT NULL, PRIMARY KEY(`postId`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'c8b98504743adfd5e60b1654c41867a6')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsPost.put("id", new TableInfo.Column("id", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        _columnsPost.put("userId", new TableInfo.Column("userId", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPost.put("isShimmer", new TableInfo.Column("isShimmer", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPost.put("postId", new TableInfo.Column("postId", "TEXT", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoPost.equals(_existingPost)) {
          return new RoomOpenHelper.ValidationResult(false, "post(com.example.poststask.data.model.PostModel).\n"
                  + " Expected:\n" + _infoPost + "\n"
                  + " Found:\n" + _existingPost);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "c8b98504743adfd5e60b1654c41867a6", "d00a484e69e1a61423ddabc9abc50e83");
